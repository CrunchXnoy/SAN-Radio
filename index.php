...
<head>
  ...
  <style>
    #ABC {
      background-image: linear-gradient(45deg, #FCDB8D, #154477);
      padding: 1em;
      border-radius: 3px;
      margin: 1em 0;
      color: #fff;
  ...
  <title>SANews 96.4 FM Online Music Player | SaatnyaOnline.Com</title>
</head>
...
<body>
      ...
      <div class="row">
        <div class="col-md-5">
          ...
          <p class="mb-4 wow fadeInLeft">
            Nikmati musik pilihan terbaik dari kami untuk menemani
            hari pendengar setia SANews 96.4 FM semua!
          </p>
          <audio controls>
            <source src="https://s7.alhastream.com/radio/8350/live" type="audio/mpeg">
            Your browser does not support the audio element.
          </audio><br><br>
          <a href="https://play.google.com/store/apps/details?id=com.alhasmedia.SANewsFM"><img src="assets/images/playstore.png" alt="PlayStore Logo" style="max-width: 40%;"></a>
        </div>
  ...
  <section id="ABC">
    <div class="container headup mb-5">
      <div class="row">
        <iframe width="100%" height="560px" src="https://alhastream.com/chatroom/Sanews"></iframe>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-10 col-md-12 pt-0">
          <p style="color:blue;">Copyright 2023 <a style="color:blue;" href="">SaatnyaOnline.Com</a> &copy; All Rights Reserved</p>
        </div>
        <div class="col-lg-2 col-md-12 socmed">
          <h2>
            <a href=""><i class="fab fa-facebook-square"></i></a>
            <a href="https://www.instagram.com/sanewsjogjagamers/?hl=id"><i class="fab fa-instagram"></i></a>
...
s1.async=true;
s1.src='https://embed.tawk.to/5f09c6ae5b59f94722ba8930/default';
s1.charset='UTF-8';
